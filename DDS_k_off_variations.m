...
odeFunc = @(t,Ci) ODEs(t,Ci, rpar, k_Off_value);
...
save('DDS_Doses_koff.mat', ...
    ...
    'k_OffStore', 'dose_in', 'radius_scale', 'thickness_scale', ...
    'DDS_geometry', ...
    'v_ret_Initial', 'v_vit_Initial', 'v_aq_Initial');

%------------------------------------------------
function derivVector=ODEs(t,y, rpar, k_Off_value) %must be (denominator, numerators)
