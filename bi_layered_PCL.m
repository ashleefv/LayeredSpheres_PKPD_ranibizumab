...
% ---- 10% suppression ----
fprintf('thickness_scale = %.4f R_C | 10%% Suppression (days) -> Retina: %.2f, Vitreous: %.2f, Aqueous: %.2f\n', ...
    thickness_scale(i), time_at_target_ret_10, time_at_target_vit_10, time_at_target_aq_10);

% ---- 50% suppression ----
fprintf('thickness_scale = %.4f R_C | 50%% Suppression (days) -> Retina: %.2f, Vitreous: %.2f, Aqueous: %.2f\n', ...
    thickness_scale(i), time_at_target_ret_50, time_at_target_vit_50, time_at_target_aq_50);
